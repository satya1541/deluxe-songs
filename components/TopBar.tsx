  ...
  return (
    <header className="top-bar">
      ...
      <div className="top-right">
        ...
        {/* Deluxe Live Sync Broadcast Link */}
        <Link
          href="/sync"
          className="topbar-live-sync-link"
          title="Deluxe 24/7 Live Sync Broadcast"
          aria-label="Deluxe 24/7 Live Sync Broadcast"
        >
          <span className="live-sync-dot" />
          <span className="topbar-btn-text">Live Sync</span>
        </Link>
        ...
        <Link
          ...
          title="Spotify Music Streamer (320kbps Master)"
          aria-label="Spotify Music Streamer 320kbps"
        >
